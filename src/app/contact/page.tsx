    ...
    return (
        <div className="w-full">
            <header className="bg-[#111827]">
                {/* Navbar */}
                <nav style={{ backgroundColor: "#fff" }} className="border-gray-200 dark:bg-gray-900">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <p>Dirección de correo electrónico: example@example.com</p>
                        <p>Número de teléfono: +1234567890</p>
                        {/* Si tienes una dirección física */}
                ...
                <div className="mt-8">
                    <p>Muchas gracias por contactarnos. Nos pondremos en contacto contigo lo antes posible.</p>
                </div>

                
                {/* Botón de Llamada a la Acción (CTA) */}
                <div className="mt-8">
                    <button className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">¡Contáctanos ahora!</button>
                </div>
            </div>
        </div>
    );
